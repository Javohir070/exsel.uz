...
<div class="content">
    <div class="flex justify-between align-center mt-10">
        ...
        <a href="{{ route("export_lab") }}" class="button box flex items-center text-gray-700"> <i data-feather="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> Export to Excel </a>
        <div>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex science-update-action items-center mr-3"
                                    href="{{ route('laboratory.edit', ['laboratory' => $xodimlar->id]) }}" data-id="2978"
                                ...
                                <a class="flex science-update-action items-center mr-3"
                                    href="{{ route('laboratory.show', ['laboratory' => $xodimlar->id]) }}" data-id="2978"
                                    data-name="sdfd" data-file="/files/papers/4735cda0-a7a3-4a45-bd93-0bc013b857dc.png"
                                    data-filename="Screenshot from 2023-04-17 16-23-56.png" data-type="66" data-date="None"
                                    data-doi="" data-publisher="" data-description="None" data-authors-count="None"
                                    data-toggle="modal" data-target="#science-paper-update-modal">
                                ...
                                <form action="{{ route('laboratory.destroy',['laboratory'=>$xodimlar->id]) }}" method="post" onsubmit="return confirm(' Rostan Ochirishni hohlaysizmi?');">
