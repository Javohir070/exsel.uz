                                    ...
                                    @foreach ($regions as $region)
                                        <tr style="border-bottom: 1px solid #E6E6E6;">
                                            <td style="color:#1881D3; font-weight: 400;">
                                                <a
                                                    href="{{ route('tashkilot_turi_doktarantura', ['id' => $region->id]) }}">
                                                    {{ $region->oz }}
                                                </a>
                                            </td>
                                            <td style="text-align: center;font-weight: 600;">
                                                {{ $region->tashkilots()->where('doktarantura_is', 1)->count() }} </td>
                                            <td style="text-align: center;">
                                                {{ $region->tashkilots()->where('doktarantura_is', 1)->where('tashkilot_turi', 'otm')->count() }}
                                            </td>
                                            <td style="text-align: center;">
                                                {{ $region->tashkilots()->where('doktarantura_is', 1)->where('tashkilot_turi', 'itm')->count() }}
                                            </td>
                                            <td style="text-align: center;">
                                            ...
                                            @php
                                                $qoniqarli = 0;
                                                foreach (
                                                    $region->tashkilots()->where('doktarantura_is', 1)->get()
                                                    as $tashkilot
                                                ) {
                                                    $qoniqarli += $tashkilot
                                                        ->doktaranturaexperts()
                                            ...
                                            @endphp
                                            <td style="text-align: center;">
                                                {{ $region->tashkilots()->where('doktarantura_is', 1)->count() - $count }}
                                            </td>
