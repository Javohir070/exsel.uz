...
@section('content')
    ...
    <div class="flex justify-between align-center mt-6 mb-6">
        ...
        <div>
            <a href="{{ route("ilmiytezislar.index") }}" class="button w-24 ml-3 bg-theme-1 text-white">
                Orqaga
            </a>
        </div>
    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2"
        ...
        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            ...
            <form id="science-paper-create-form" method="POST"
                action="{{ route('ilmiytezislar.update', $ilmiytezislar->id) }}" class="validate-form"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="mavzu" value="{{ $ilmiytezislar->mavzu }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="date" name="chopq_sana" value="{{ $ilmiytezislar->chopq_sana }}"
                            class="input w-full border mt-2" required>
                        @error('chopq_sana')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="kon_full_nomi" value="{{ $ilmiytezislar->kon_full_nomi }}"
                            class="input w-full border mt-2" required>
                        @error('kon_full_nomi')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="kon_qisqa_nomi" value="{{ $ilmiytezislar->kon_qisqa_nomi }}"
                            class="input w-full border mt-2" required>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="soni" value="{{ $ilmiytezislar->soni }}" class="input w-full border mt-2"
                            required>
                        @error('soni')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="nashriyot" value="{{ $ilmiytezislar->nashriyot }}"
                            class="input w-full border mt-2" required>
                        @error('nashriyot')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="annotatsiya" value="{{ $ilmiytezislar->annotatsiya }}"
                            class="input w-full border mt-2" required>
                        @error('annotatsiya')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="url" name="url" value="{{ $ilmiytezislar->url }}" class="input w-full border mt-2">
                        @error('url')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="url" name="doi" value="{{ $ilmiytezislar->doi }}" class="input w-full border mt-2">
                        @error('doi')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="px-5 pb-5 text-center mt-4">
                <a href="{{ route('ilmiytezislar.index') }}" class="button delete-cancel w-32 border text-gray-700 mr-1">
                    Bekor qilish
                </a>
