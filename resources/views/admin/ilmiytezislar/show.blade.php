            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2"><a href="{{ $ilmiytezislar->url }}" target="_blank"
                                style="text-decoration: none;">{{ $ilmiytezislar->url }}</a> </td>
                    ...
                    <tr>
                        <td class="border px-4 py-2"><a href="{{ $ilmiytezislar->doi }}" target="_blank"
                                style="text-decoration: none;">{{ $ilmiytezislar->doi }}</a></td>
