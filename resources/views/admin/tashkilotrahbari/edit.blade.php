            ...
            <form id="science-paper-create-form" method="POST"
                ...
                <div class="grid grid-cols-12 gap-2">
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="fish" value="{{$tashkilot->fish}}" class="input w-full border mt-2"
                            required="">
                        @error('fish')
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="u_fish" value="{{$tashkilot->u_fish}}" class="input w-full border mt-2"
                            required="">
                        @error('u_fish')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="email" name="u_email" value="{{$tashkilot->u_email}}" class="input w-full border mt-2"
                            required="">
                        @error('u_email')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="u_phone" value="{{$tashkilot->u_phone}}" class="input w-full border mt-2"
                            required="">
                        @error('u_phone')
                            <div class="error">{{ $message }}</div>
                        @enderror
