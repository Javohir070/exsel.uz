        ...
        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <form id="science-paper-create-form" method="POST"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6 ">
                        <label class="flex flex-col sm:flex-row"> <span
                                class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Tashkilot qisqa nomi massalan(TATU,
                            O'zMU)
                        </label>
                        <input type="text" name="name_qisqachasi" value="{{ $tashkilot->name_qisqachasi }}"
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="tash_yil" value="{{ $tashkilot->tash_yil }}"
                            class="input w-full border mt-2" required="">
                    </div>
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="yur_manzil" value="{{ $tashkilot->yur_manzil }}"
                            class="input w-full border mt-2" required="">
                    </div>
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="paoliyat_manzil" value="{{ $tashkilot->paoliyat_manzil }}"
                            class="input w-full border mt-2" required="">
                    </div>
                    <div class="w-full col-span-6 ">
                        <label class="flex flex-col sm:flex-row"> <span
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="web_sayti" value="{{ $tashkilot->web_sayti }}"
                            class="input w-full border mt-2" required="">
                    </div>
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="shtat_bir" value="{{ $tashkilot->shtat_bir }}"
                            class="input w-full border mt-2" required="">
                    </div>
                    <div class="w-full col-span-6 ">
                        <label class="flex flex-col sm:flex-row"> <span
                        ...
                        <input type="text" name="tash_xodimlar" value="{{ $tashkilot->tash_xodimlar }}"
                            class="input w-full border mt-2" required="">
                    </div>
                    <div class="w-full col-span-6 ">
                        <label class="flex flex-col sm:flex-row"> <span
                        ...
                        <input type="text" name="ilmiy_xodimlar" value="{{ $tashkilot->ilmiy_xodimlar }}"
                            class="input w-full border mt-2" required="">
                    </div>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="boshqariv" id="science-sub-category" class="input border w-full mt-2" required>
                            ...
                            <option value="Direktor" {{ $tashkilot->boshqariv == 'Direktor' ? 'selected' : '' }}>Direktor
                            </option>
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="stir_raqami" value="{{ $tashkilot->stir_raqami }}"
                            class="input w-full border mt-2" required="">
                    </div>
                    <div class="w-full col-span-6 ">
                        <label class="flex flex-col sm:flex-row">Tashkilot hisob raqami
                        </label>
                        <input type="text" name="hisob_raqam" value="{{ $tashkilot->hisob_raqam }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <label class="flex flex-col sm:flex-row"> <span
                                class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> logo
                        </label>
            ...
            <div class="px-5 pb-5 text-center mt-4">
                <a href="{{ route('tashkilot.index') }}" data-dismiss="modal"
