...
@section('content')
                                ...
                                <table class="table">
                                    <thead style="background: #F4F8FC;">
                                        <tr>
                                            ...
                                            <th class="whitespace-no-wrap" style="text-align: center;">Boshqa tashkilotlar
                                            </th>
    ...
    @role(['admin', 'Xodimlar_uchun_masul', 'Asbob_uskunalarga_masul', 'Tashkilot_pasporti_uchun_masul',
    ...
    <script>
        ...
        const barChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["Ilmiy maqolalar", "Ilmiy tezislar", " Intellektual mulk ", "Dalolatnomalar ",
                    "Monografiyalar "
