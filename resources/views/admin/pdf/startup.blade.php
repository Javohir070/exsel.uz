...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <h2 class="subtitle">Startup loyihalari natijalari bo‘yicha o‘tkazilgan
            ...
            <div class="form-group">
                <div class="form-row">
                    ...
                    <span class="form-input">{{ $startup->name }}</span>
                </div>
                <div class="form-row">
                    <span class="form-label title">Loyiha rahbari:</span>
                    <span class="form-input">{{ $startup->loyiha_rahbari }}</span>
                </div>
                <div class="form-row">
                    <span class="form-label title">Ijrochi tashkilot:</span>
                    <span class="form-input">{{ $startup->ijrochi_tashkilot }}</span>
                </div>
            </div>
