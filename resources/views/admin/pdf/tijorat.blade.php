...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <h2 class="subtitle">Tijoratlashtirish natijalari bo‘yicha o‘tkazilgan
                texnik ekspertiza</h2>
            <h3 class="heading">XULOSASI</h3>

            <div class="form-group">
                <div class="form-row">
                    <span class="form-label title">Loyiha nomi:</span>
                    <span class="form-input">{{ $tijorat->name }}</span>
                </div>
                <div class="form-row">
                    <span class="form-label title">Loyiha rahbari:</span>
                    <span class="form-input">{{ $tijorat->loyiha_rahbari }}</span>
                </div>
                <div class="form-row">
                    <span class="form-label title">Ijrochi tashkilot:</span>
                    <span class="form-input">{{ $tijorat->ijrochi_tashkilot }}</span>
                </div>
            </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td class="title">1.</td>
                        <td>
                            Loyiha Kalendar rejasiga ko‘ra ajratilgan grant mablag‘larni maqsadli sarflanganligi.
                        </td>
                    ...
                    <tr>
                        <td class="title">2.</td>
                        <td>
                            Sotib olingan asbob va uskunalarni balansga olinganligi.
                        </td>
                        <td style="text-align: center;">
                    ...
                    <tr>
                        <td class="title">3.</td>
                        <td>
                            Loyiha doirasida olinishi lozim 
                                bo‘lgan xodimlar soni, xaqiqatda ishga olingan xodimlar soni.
                        </td>
                        <td style="text-align: center;">
                    ...
                    <tr>
                        <td class="title">4.</td>
                        <td>
                            Loyiha doirasida ishlab chiqilgan mahsulot miqdori? 
                                O‘lchov birligiga ko‘ra (dona, kg, metr...).
                        </td>
                        <td style="text-align: center;">
                    ...
                    <tr>
                        <td class="title">8.</td>
                        <td>
                            Loyihani amalga oshirish bo‘yicha hisobot topshirib kelinganligi.
                        </td>
                        <td style="text-align: center;">
                    ...
                    <tr>
                        <td class="title">9.</td>
                        <td>
                            Mahsulot bo‘yicha sertifikat olinganligi.
                        </td>
                        <td style="text-align: center;">
                    ...
                    <tr>
                        ...
                        <td>
                            Loyihani ishga tushirish bilan bog‘liq muammolar.
                        </td>
                        <td style="text-align: center;">
                    ...
                    <tr>
                        ...
                        <td>
                            Kalendar rejaga muvofiq ishlarni bajarilganligi.
                        </td>
                        <td style="text-align: center;">
