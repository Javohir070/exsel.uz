    ...
    <div class="content">
        <div class="flex justify-between align-center mt-10">
            ...
            <div>
                <div>
                    @role('admin')
                        <a href="{{ route('laboratory.show', ['laboratory' => $labId]) }}" class="button  bg-theme-1 text-white">
                            Orqaga
                        </a>
                    @endrole
                    @role('labaratoriyaga_masul')
                        <a href="{{ route('laboratoriya.index') }}" class="button  bg-theme-1 text-white">
                            Orqaga
                        </a>
                    @endrole
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    @foreach ($izlanvchi_phd as $xodimlar)
                        <tr class="intro-x">
                            <td>{{ $loop->index + 1 }}</td>
                            <td>
                ...
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                    <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                        <form id="science-paper-create-form" method="POST"
                            action="{{ route('emport_izlanuvchi.index') }}" class="validate-form"
                            ...
                            <div class="grid grid-cols-12 gap-2">
                                ...
                                <div class="w-full col-span-12">
                                    ...
                                    <input type="file" name="file" style="padding-left: 0"
                                        class="input w-full mt-2" required="">
