...
<div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2" style="background: white;
    ...
    <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
        <form id="science-paper-create-form" method="POST" action="{{ route("izlanuvchilar.store") }}" class="validate-form"
            ...
            <div class="grid grid-cols-12 gap-2">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="jshshir" value="{{ old('jshshir') }}" class="input w-full border mt-2" required="">
                    @error('jshshir')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div> 
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text"  name="pasport_seriya" value="{{ old('pasport_seriya') }}"   class=" input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6">
                    ...
                    <select name="talim_turi" value="{{ old('talim_turi') }}" id="science-sub-category" class="input border w-full mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="ixtisoslik" value="{{ old('ixtisoslik') }}" class="input w-full border mt-2" required="">
                    @error('ixtisoslik')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6">
                    ...
                    <select name="loyihada_ishtiroki" value="{{ old('loyihada_ishtiroki') }}" id="ish_tartibi"  id="science-sub-category" class="input border w-full mt-2" required="">
