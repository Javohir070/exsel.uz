...
@section('content')
            ...
            <form id="science-paper-create-form" id="phone-form" method="POST" action="{{ route('izlanuvchilar.store') }}"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="number" name="jshshir" value="{{ old('jshshir') }}" class="input w-full border mt-2"
                            required="">
                        @error('jshshir')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="pasport_seriya" value="{{ old('pasport_seriya') }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="talim_turi" value="{{ old('talim_turi') }}" id="science-sub-category"
                            class="input border w-full mt-2" required="">
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="ixtisoslik" value="{{ old('ixtisoslik') }}"
                            class="input w-full border mt-2" required="">
                        @error('ixtisoslik')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="date" name="qabul_qilgan_yil" value="{{ old('qabul_qilgan_yil') }}"
                            class="input w-full border mt-2" required="">
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="tel" id="phone" maxlength="17" required name="phone"
                            placeholder="+998 90 123 45 67" value="{{ old('phone') }}" class="input w-full border mt-2"
                            required="">
                        @error('phone')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="loyihada_ishtiroki" value="{{ old('loyihada_ishtiroki') }}" id="ish_tartibi"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Telefon raqam formatiga moslashuvchi funktsiya
            phoneInput.addEventListener('input', (e) => {
                let value = phoneInput.value.replace(/\D/g, ''); // Raqamlarni olish
                let formattedValue = '+';

                if (value.startsWith('998')) {
                    value = value.slice(3); // "998" ni olib tashlash
                    formattedValue += '998 ';
                } else {
            ...
            // Formatni tekshirish funksiyasi
            phoneForm.addEventListener('submit', (e) => {
                e.preventDefault();
                const phonePattern = /^\+998 \d{2} \d{3} \d{2} \d{2}$/;
                if (!phonePattern.test(phoneInput.value)) {
                    errorMsg.textContent = "Telefon raqam formati noto'g'ri!";
                } else {
                    errorMsg.textContent = "";
                    alert("Telefon raqam qabul qilindi: " + phoneInput.value);
                }
            });
        });
    </script>
