...
@section('content')
    ...
    <div class="content">
        <div class="flex justify-between align-center mt-6 mb-6">
            ...
            <a href="{{ route("intellektualmulks.export") }}" class="button box flex items-center text-gray-700">
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <form action="{{ route('intellektualmulk.destroy', ['intellektualmulk' => $xodimlar->id]) }}"
