...
<div class="content">
    <div class="flex justify-between align-center mt-10">
        ...
        <a href="{{ route("intellektualmulks.export") }}" class="button box flex items-center text-gray-700"> <i data-feather="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> Export to Excel </a>
        <!-- <div>
