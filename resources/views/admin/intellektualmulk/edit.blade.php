...
@section('content')
    ...
    <div class="flex justify-between align-center mt-6 mb-6">
        ...
        <div>
            <a href="{{ route("intellektualmulk.index") }}" class="button w-24 ml-3 bg-theme-1 text-white">
                Orqaga
            </a>
        </div>
    </div>
    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2"
        ...
        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <form id="science-paper-create-form" method="POST"
                action="{{ route('intellektualmulk.update', $intellektualmulk->id) }}" class="validate-form"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="type" id="science-sub-category" class="input border w-full mt-2" required="">
                            ...
                            <option value="Seleksiya yutuqlari (o‘simlik navlari)">Seleksiya yutuqlari (o‘simlik navlari)
                            </option>

                            <option value="Seleksiya yutuqlari (xayvon zotlari)">Seleksiya yutuqlari (xayvon zotlari)
                            </option>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="mavzu" value="{{ old('mavzu', $intellektualmulk->mavzu) }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="annotatsiya"
                            value="{{ old('annotatsiya', $intellektualmulk->annotatsiya) }}"
                            class="input w-full border mt-2" required>
                        @error('annotatsiya')
                            <div class="error">{{ $message }}</div>
                        @enderror
