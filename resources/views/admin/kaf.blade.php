                    ...
                    <a href="">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{ $kaf_IlmiyLoyiha }}</div>
                    ...
                    <a href="">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{ $kaf_Xujalik }}</div>
                    ...
                    <a href="">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{ $kaf_Xodimlar }}</div>
                    ...
                    <a href="">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{ $kaf_Ilmiymaqolalar }}</div>
                                <div class="text-base text-gray-600 mt-1">Ilmiy maqolalar</div>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{ $kaf_Ilmiytezislar }}</div>
                                <div class="text-base text-gray-600 mt-1">Ilmiy tezislar</div>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-base text-gray-600 mt-1">Monografiyalar</div>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{ $kaf_Intellektualmulk }}</div>
                                <div class="text-base text-gray-600 mt-1">Intellektual mulk</div>
                            </div>
                        </div>
                    </a>
                </div>
