        ...
        <form id="science-paper-create-form" method="POST" action="{{ route("xujalik.store") }}" class="validate-form"
            ...
            <div class="grid grid-cols-12 gap-2">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="intellektual_sana" class="input w-full border mt-2" required="">
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="sh_sanasi" class="input w-full border mt-2" required="">
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="shkelib_sana" class="input w-full border mt-2" required="">
                </div>
