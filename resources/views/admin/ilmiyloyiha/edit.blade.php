        ...
        <form id="science-paper-create-form" method="POST" action="{{ route("ilmiyloyiha.update",['ilmiyloyiha'=>$ilmiyloyiha->id]) }}" class="validate-form"
            ...
            <div class="grid grid-cols-12 gap-2">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <select name="rahbariilmiy_darajasi"  id="science-sub-category" class="input border w-full mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <select name="rahbariilmiy_unvoni"  id="science-sub-category" class="input border w-full mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="r_lavozimi" value="{{ $ilmiyloyiha->r_lavozimi }}" class="input w-full border mt-2" >
                </div>
               ...
               <div class="w-full col-span-6 ">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="ijrochi_tashkilot" value="{{ $ilmiyloyiha->ijrochi_tashkilot }}" class="input w-full border mt-2" required="">
               ...
               <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="hamrahbar_fish" value="{{ $ilmiyloyiha->hamrahbar_fish }}" class="input w-full border mt-2" >
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="hamr_ishjoyi" value="{{ $ilmiyloyiha->hamr_ishjoyi }}" class="input w-full border mt-2" >
                    @error('hamr_ishjoyi')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="hamr_lavozimi" value="{{ $ilmiyloyiha->hamr_lavozimi }}" class="input w-full border mt-2" >
                    @error('hamr_lavozimi')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="hamr_davlati" value="{{ $ilmiyloyiha->hamr_davlati }}" class="input w-full border mt-2" >
                    @error('hamr_davlati')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="joyyilajratilgan_mablag" value="{{ $ilmiyloyiha->joyyilajratilgan_mablag }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="shtat_birligi" value="{{ $ilmiyloyiha->shtat_birligi }}" class="input w-full border mt-2" required="">
                    @error('shtat_birligi')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="ijrochilar_soni" value="{{ $ilmiyloyiha->ijrochilar_soni }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="ortacha_yoshi" value="{{ $ilmiyloyiha->ortacha_yoshi }}" class="input w-full border mt-2" required="">
                    @error('ortacha_yoshi')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="moddiy_texnik_mablaglar" value="{{ $ilmiyloyiha->moddiy_texnik_mablaglar }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="jami_summaga_nisbatan" value="{{ $ilmiyloyiha->jami_summaga_nisbatan }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="jami_chop_joriyyil" value="{{ $ilmiyloyiha->jami_chop_joriyyil }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="jami_chop_jami" value="{{ $ilmiyloyiha->jami_chop_jami }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="mahalliymaqola_joriyyil" value="{{ $ilmiyloyiha->mahalliymaqola_joriyyil }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="mahalliymaqol_jami" value="{{ $ilmiyloyiha->mahalliymaqol_jami }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="xorijiymaqola_joriyyil" value="{{ $ilmiyloyiha->xorijiymaqola_joriyyil }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="xorijiymaqola_jami" value="{{ $ilmiyloyiha->xorijiymaqola_jami }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="scopus_joriyyil" value="{{ $ilmiyloyiha->scopus_joriyyil }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="scopus_jami" value="{{ $ilmiyloyiha->scopus_jami }}" class="input w-full border mt-2" required="">
                    @error('scopus_jami')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="tezislar_joriyyil" value="{{ $ilmiyloyiha->tezislar_joriyyil }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="tezislar_jami" value="{{ $ilmiyloyiha->tezislar_jami }}" class="input w-full border mt-2" required="">
                    @error('tezislar_jami')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="ilmiy_mon_joriyyil" value="{{ $ilmiyloyiha->ilmiy_mon_joriyyil }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="ilmiy_mon_jami" value="{{ $ilmiyloyiha->ilmiy_mon_jami }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="olinganpatent_joriyyil" value="{{ $ilmiyloyiha->olinganpatent_joriyyil }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="olinganpatent_jami" value="{{ $ilmiyloyiha->olinganpatent_jami }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="patentga_berilgansoni" value="{{ $ilmiyloyiha->patentga_berilgansoni }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="dasturiy_maxguv_joriyyil" value="{{ $ilmiyloyiha->dasturiy_maxguv_joriyyil }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="number" name="dasturiy_maxguv_jami" value="{{ $ilmiyloyiha->dasturiy_maxguv_jami }}" class="input w-full border mt-2" required="">
                ...
                <div class="w-full col-span-6 ">
                    ...
                    {{-- <input type="text" name="y2024" value="{{ $ilmiyloyiha->y2024 }}" class="input w-full border mt-2" required=""> --}}
                    <textarea name="hisobot_davrida_natijalar" class="input w-full border mt-2" id="" cols="5" rows="5">{{ $ilmiyloyiha->hisobot_davrida_natijalar }}</textarea>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    {{-- <input type="number" name="y2024" value="{{ $ilmiyloyiha->y2024 }}" class="input w-full border mt-2" required=""> --}}
                    <textarea name="loyiha_yakunida" id="" class="input w-full border mt-2" cols="5" rows="5">{{ $ilmiyloyiha->loyiha_yakunida }}</textarea>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    {{-- <input type="number" name="y2024" value="{{ $ilmiyloyiha->y2024 }}" class="input w-full border mt-2" required=""> --}}
                    <textarea name="ilmiy_ishlanma" id="" class="input w-full border mt-2" cols="5" rows="5">{{ $ilmiyloyiha->ilmiy_ishlanma }}</textarea>
                ...
                <div class="w-full col-span-6 ">
                    <label class="flex flex-col sm:flex-row"> <span
                            class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span>Tashkilotingiz tomonidan davlat buyurtmasi asosida amalga oshirilayotgan ilmiy tadqiqot loyihalarining asosiy natijalari to‘g‘risida
                            MA’LUMOTNI yuklang </label>
                    <input type="file" name="malumotnoma" value="{{ $ilmiyloyiha->malumotnoma }}" class="input w-full border mt-2" required="">
                    @error('malumotnoma')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="file" name="savolnoma" value="{{ $ilmiyloyiha->savolnoma }}" class="input w-full border mt-2" required="">
                    @error('savolnoma')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
