                                        ...
                                        <tbody>
                                            ...
                                            <tr style="border-bottom: 1px solid #E6E6E6;">
                                                <td style="color:#1881D3; font-weight: 400;">
                                                    <a href="{{ route('search_ilmiy_loyhalar', ['query' => $region->id]) }}">
                                                        {{ $region->oz }}
                                                    </a>
                                                </td>
                                                ...
                                                <td style="text-align: center;">{{ $region->tashkilots()->where('ilmiyloyiha_is', 1)->where('tashkilot_turi', null)->count() }} </td>
