            ...
            <table class="table">
                <tbody>
                    <div style="display: flex;justify-content: space-between; border-bottom: 1px solid #e2e8f0; padding-bottom: 20px;">
                        ...
                        <tr class="bg-gray-200">
                            <!-- <th class="border border-b-2 ">15</th> -->
                            <th class="border border-b-2 ">Web of Science va Scopus bazasidagi xalqaro nashrlardagi maqolalar soni (Joriy yil uchun) </th>
                            <th class="border border-b-2 ">Web of Science va Scopus bazasidagi xalqaro nashrlardagi maqolalar soni (Jami) </th>
                        </tr>
                        ...
                        <tr class="bg-gray-200">
                            ...
                            <th class="border border-b-2 ">Loyiha yakunida yaratilgan ishlanma (texnologiya) nomi va qisqacha tavsifi </th>
                        </tr>
                        ...
                        <tr class="bg-gray-200">
                            <!-- <th class="border border-b-2 ">15</th> -->
                            <th class="border border-b-2 ">Ilmiy ishlanma joriy etiladigan (tijoratlashtiriladigan) tarmoq (soha) va kutilayotgan natijalar (mavjud ehtiyoj, iqtisodiy samaradorlik ko‘rsatkichlari tahlili) </th>
