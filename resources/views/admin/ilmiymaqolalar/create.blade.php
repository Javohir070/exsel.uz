        ...
        <form id="science-paper-create-form" method="POST" action="{{ route("ilmiymaqolalar.store") }}"
            ...
            <div class="grid grid-cols-12 gap-2">
                ...
                <div class="w-full col-span-6">
                    ...
                    <input type="text" name="jurnal_soni" value="{{ old('jurnal_soni') }}" class="input w-full border mt-2" required>
                    @error('jurnal_soni')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full col-span-6">
                    ...
                    <input type="text" name="jurnal_issn_raqami" value="{{ old('jurnal_issn_raqami') }}" class="input w-full border mt-2" required>
