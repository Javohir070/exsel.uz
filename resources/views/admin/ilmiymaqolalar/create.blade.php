...
@section('content')
    ...
    <div class="flex justify-between align-center mt-6 mb-6">
        ...
        <h2 class="intro-y text-lg font-medium">Ilmiy maqola ma'lumotni qo'shish</h2>
    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2" style="background: white;
        ...
        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <form id="science-paper-create-form" method="POST" action="{{ route("ilmiymaqolalar.store") }}"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="mavzu" value="{{ old('mavzu') }}" class="input w-full border mt-2"
                            required>
                        @error('mavzu')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="jurnal_nomi" value="{{ old('jurnal_nomi') }}"
                            class="input w-full border mt-2" required>
                        @error('jurnal_nomi')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="jurnal_soni" value="{{ old('jurnal_soni') }}"
                            class="input w-full border mt-2" required>
                        @error('jurnal_soni')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="jurnal_issn_raqami" value="{{ old('jurnal_issn_raqami') }}"
                            class="input w-full border mt-2" required>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="nashriyot" value="{{ old('nashriyot') }}" class="input w-full border mt-2"
                            required>
                        @error('nashriyot')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="annotatsiya" value="{{ old('annotatsiya') }}"
                            class="input w-full border mt-2" required>
                        @error('annotatsiya')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="url" name="url" value="{{ old('url') }}" class="input w-full border mt-2">
                        @error('url')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="url" name="doi" value="{{ old('doi') }}" class="input w-full border mt-2">
                        @error('doi')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
