            ...
            <table class="table">
                <tbody>
                    <div
                        ...
                        <div style="font-size:18px;font-weight: 400;">{{ $ilmiymaqolalar->mavzu }} ilmiy maqola ma’lumot
                        </div>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2"><a href="{{ $ilmiymaqolalar->url }}" target="_blank"
                                style="text-decoration: none;">{{ $ilmiymaqolalar->url }}</a> </td>
                    ...
                    <tr>
                        <td class="border px-4 py-2"><a href="{{ $ilmiymaqolalar->doi }}" target="_blank"
                                style="text-decoration: none;">{{ $ilmiymaqolalar->doi }}</a></td>
