...
@section('content')
    ...
    <div class="flex justify-between align-center mt-6 mb-6">
        ...
        <h2 class="intro-y text-lg font-medium">Ilmiy maqola ma'lumotni tahrirlash </h2>

        <div>
            <a href="{{ route("ilmiymaqolalar.index") }}" class="button w-24 ml-3 bg-theme-1 text-white">
                Orqaga
            </a>
        </div>
    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2"
        ...
        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <form id="science-paper-create-form" method="POST"
                action="{{ route('ilmiymaqolalar.update', $ilmiymaqolalar->id) }}" class="validate-form"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="type" id="science-sub-category" class="input border w-full mt-2" required="">
                            ...
                            <option value="Respublika miqyosidagi jurnallar">Respublika miqyosidagi jurnallar</option>

                            <option value="Xalqaro miqyosidagi jurnallar">Xalqaro miqyosidagi jurnallar</option>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="mavzu" value="{{ $ilmiymaqolalar->mavzu }}"
                    ...
                    <div class="w-full col-span-6">
                        <label class="flex flex-col sm:flex-row">
                            <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span>Jurnal nomi
                        </label>
                        <input type="text" name="jurnal_nomi" value="{{ $ilmiymaqolalar->jurnal_nomi }}"
                            class="input w-full border mt-2" required>
                        @error('jurnal_nomi')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        <label class="flex flex-col sm:flex-row">
                            <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Seriyasi/Jurnal soni
                        </label>
                        <input type="text" name="jurnal_soni" value="{{ $ilmiymaqolalar->jurnal_soni }}"
                            class="input w-full border mt-2" required>
                        @error('jurnal_soni')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        <label class="flex flex-col sm:flex-row">
                            <span class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span>Jurnal ISSN raqami
                        </label>
                        <input type="text" name="jurnal_issn_raqami" value="{{ $ilmiymaqolalar->jurnal_issn_raqami }}"
                            class="input w-full border mt-2" required>
                        @error('jurnal_issn_raqami')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="nashriyot" value="{{ $ilmiymaqolalar->nashriyot }}"
                            class="input w-full border mt-2" required>
                        @error('nashriyot')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="annotatsiya" value="{{ $ilmiymaqolalar->annotatsiya }}"
                            class="input w-full border mt-2" required>
                        @error('annotatsiya')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="fan_yunalishi" id="science-sub-category"
                            class="select2 w-full input border w-full mt-2" required>
                            <option value=""></option>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="url" name="url" value="{{ $ilmiymaqolalar->url }}" class="input w-full border mt-2">
                        @error('url')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="url" name="doi" value="{{ $ilmiymaqolalar->doi }}" class="input w-full border mt-2">
                        @error('doi')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div id="mualliflar-container">
                            @foreach(json_decode($ilmiymaqolalar->mualliflar_json) as $muallif)
                                <div class="muallif-input">
                                    <input type="text" name="mualliflar_json[]" value="{{ old('mualliflar_json[]', $muallif) }}"
                                        class="input w-full border mt-2" placeholder="Muallifning F.I.Sh" required>
                                </div>
                            @endforeach
                        </div>
