            ...
            <form id="science-paper-create-form" method="POST"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="lavozim" value="{{ $stajirovka->lavozim }}" class="input w-full border mt-2"
                            required="">
                        @error('lavozim')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="yunalishi" value="{{ $stajirovka->yunalishi }}" class="input w-full border mt-2" required="">
                        @error('yunalishi')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="file" name="ilmiy_hisobot" value=""
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="file" name="egallangan_bilim" value=""
                            class="input w-full border mt-2" required="">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="file" name="ishlar_natijalari" value=""
                            class="input w-full border mt-2" required="">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="file" name="xalqarotan_jur_nashr" value=""
                            class="input w-full border mt-2" required="">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="file" name="biryil_davomida" value=""
                            class="input w-full border mt-2" required="">
