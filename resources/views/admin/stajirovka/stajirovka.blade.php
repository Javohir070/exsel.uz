                ...
                <tbody>
                    ...
                    @forelse ($stajirovkas as $xodimlar)
                        ...
                        <tr class="intro-x">
                            ...
                            <td
                                style="color: {{ ($h = $xodimlar->stajirovkaexpert()->where('quarter', 3)->first()->status ?? null) == 'Ijobiy' ? 'green' : ($h == 'Salbiy' ? 'blue' : 'red') }}">
                                {{ $xodimlar->stajirovkaexpert()->where('quarter', 3)->first()->status ?? "Tasdiqlanmagan" }}
                            </td>
                            <td
                                style="color: {{ ($h = $xodimlar->stajirovkaexpert()->where('quarter', 3)->first()->holati ?? null) == 'Tasdiqlandi' ? 'green' : ($h == 'yuborildi' ? 'blue' : 'red') }}">
