                ...
                <tbody>
                    ...
                    @forelse ($stajirovkas as $xodimlar)
                        ...
                        <tr class="intro-x">
                            ...
                            <td
                                style="color: {{ ($h = $xodimlar->stajirovkaexpert()->where('quarter', $monitoring->id)->first()->status ?? null) == 'Ijobiy' ? 'green' : ($h == 'Salbiy' ? 'blue' : 'red') }}">
                                {{ $xodimlar->stajirovkaexpert()->where('quarter', $monitoring->id)->first()->status ?? "Tasdiqlanmagan" }}
                            </td>
                            <td
                                style="color: {{ ($h = $xodimlar->stajirovkaexpert()->where('quarter', $monitoring->id)->first()->holati ?? null) == 'Tasdiqlandi' ? 'green' : ($h == 'yuborildi' ? 'blue' : 'red') }}">
                    ...
                    @empty
                        <tr>
                            <td colspan='7' style="text-align: center;">Ma'lumot yo'q</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
