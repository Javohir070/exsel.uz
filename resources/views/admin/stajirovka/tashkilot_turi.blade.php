                    ...
                    <div class="grid grid-cols-12 gap-6 mt-0">
                            ...
                            <div class="col-span-12 mt-2 " style="background: white; border-radius: 10px;">
                                <div class="intro-y block sm:flex items-center py-4" style="justify-content: space-between;">
                                    ...
                                    <a href="{{ route("stajirovkalar.index") }}" class="button w-24 bg-theme-1 text-white mr-4">
                                        Orqaga
                                    </a>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="color:#1881D3; font-weight: 400;">
                                                    <a href="{{ route('search_stajirovka', ['id' => $regions->id, 'type'=>'otm']) }}">OTM</a>     
                                                    </td>
                                            ...
                                            <tr>
                                                <td style="color:#1881D3; font-weight: 400;">
                                                    <a href="{{ route('search_stajirovka', ['id' => $regions->id,'type'=>'itm']) }}"> Ilmiy tashkilotlar</a>    
                                                </td>
                                                <td style="text-align: center;">
                                            ...
                                            <tr>
                                                <td style="color:#1881D3; font-weight: 400;">
                                                    <a href="{{ route('search_stajirovka', ['id' => $regions->id, 'type'=>'boshqa']) }}">Boshqa tashkilotlar</a>    
                                                </td>
                                                <td style="text-align: center;">
