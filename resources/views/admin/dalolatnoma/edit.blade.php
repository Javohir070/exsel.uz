...
@section('content')
    ...
    <div class="flex justify-between align-center mt-6 mb-6">
        ...
        <h2 class="intro-y text-lg font-medium">Dalolatnomani ma'lumotni tahrirlash</h2>

        <div>
            <a href="{{ route("dalolatnoma.index") }}" class="button w-24 ml-3 bg-theme-1 text-white">
                Orqaga
            </a>
        </div>
    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2" style="background: white;
        ...
        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <form id="science-paper-create-form" method="POST" action="{{ route("dalolatnoma.update", $dalolatnoma->id) }}"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="name" value="{{ $dalolatnoma->name }}" class="input w-full border mt-2"
                            required="">
                        @error('name')
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="raqami" value="{{ $dalolatnoma->raqami }}" class="input w-full border mt-2"
                            required="">
                        @error('raqami')
                            <div class="error">{{ $message }}</div>
                        @enderror
