            ...
            <form id="science-paper-create-form" method="POST" action="{{ route("xodimlar.store") }}" class="validate-form"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="date" id="datepicker" name="yil" value="{{ old('yil') }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="jinsi" value="{{ old('jinsi') }}" id="science-sub-category"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="ish_tartibi" id="ish_tartibi" value="{{ old('ish_tartibi') }}"
                            id="science-sub-category" class="input border w-full mt-2" required="">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="shtat_birligi" value="{{ old('shtat_birligi') }}" id="science-sub-category"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="malumoti" value="{{ old('malumoti') }}" id="science-sub-category"
                            class="input border w-full mt-2" required="">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="pedagoglik" value="{{ old('pedagoglik') }}" id="science-sub-category"
                            class="input border w-full mt-2" required="">
                    ...
                    <div class="w-full col-span-6 " style="display: none;" id="orindoshlik-input">
                        ...
                        <input type="text" name="urindoshlik_asasida" value="{{ old('urindoshlik_asasida') }}"
                            class="input w-full border mt-2" required="">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="ilmiy_daraja" id="ilmiy_daraja" value="{{ old('ilmiy_daraja') }}"
                    ...
                    <div class="w-full col-span-6 " id="ilmiy-daraja-input" style="display: none;">
                        ...
                        > -->
                        <select name="ilmiy_daraja_yil" value="{{ old('ilmiy_daraja_yil') }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="ilmiy_unvoni" id="ilmiy_unvoni" value="{{ old('ilmiy_unvoni') }}"
                            id="science-sub-category" class="input border w-full mt-2">
                    ...
                    <div class="w-full col-span-6 " id="ilmiy-unvon-input" style="display: none;">
                        ...
                        <select name="ilmiy_unvoni_y" value="{{ old('ilmiy_unvoni_y') }}"
                            class="science-sub-categoryyil input border w-full mt-2 " required="">
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="text" name="ixtisosligi" value="{{ old('ixtisosligi') }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <select name="uzbek_panlar_azosi" value="{{ old('uzbek_panlar_azosi') }}" id="science-sub-category"
                            class="input border w-full mt-2" required="">
                    ...
                    <div class="w-full col-span-6 ">
                        ...
                        <input type="tel" name="phone" placeholder="+998 90 123 45 67" value="+998"
                            class="input w-full border mt-2" required="">
                        @error('phone')
                            <div class="error">{{ $message }}</div>
                        @enderror
