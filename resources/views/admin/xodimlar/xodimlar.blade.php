    ...
    <div class="flex justify-between align-center mt-10">
        ...
        <div>
            <div> 
                ...
                <a href="/admin/Xodimlar.xlsx" class="button box flex items-center text-gray-700"> <i data-feather="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> Export to Excel </a>
            </div>
        </div>
