...
@section('content')
    <div class="content">
        <div class="flex justify-between align-center mt-6 mb-6">
            <h2 class="intro-y text-lg font-medium">Tijorat loyihasi qo'shish</h2>
        ...
        <div class="intro-y col-span-12 p-5" style="background-color: white; border-radius: 8px;">
            <form method="POST" action="{{ route('tijorat.store', request()->query()) }}" class="validate-form">
                @csrf
                <div class="grid grid-cols-12 gap-3">
                    <div class="col-span-12 sm:col-span-6">
                        <label class="flex flex-col sm:flex-row"><span class="mt-1 mr-1 text-xs text-red-600">*</span>Loyiha nomi</label>
                        <input type="text" name="name" value="{{ old('name') }}" class="input w-full border mt-2" required maxlength="600">
                        @error('name')
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="loyiha_rahbari" value="{{ old('loyiha_rahbari') }}" class="input w-full border mt-2" required maxlength="600">
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="ijrochi_tashkilot" value="{{ old('ijrochi_tashkilot') }}" class="input w-full border mt-2" required maxlength="600">
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="summa" value="{{ \App\Models\Tijorat::formatMoneyDisplay(old('summa', '')) }}"
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <span class="text-xs text-gray-600 block -mt-1 mb-1">Faqat raqam va bitta nuqta (o‘nlik); mingliklar uchun bo‘shliq ishlatishingiz mumkin.</span>
                        <input type="text" name="tash_summasi" value="{{ \App\Models\Tijorat::formatMoneyDisplay(old('tash_summasi', '')) }}"
                            class="input w-full border mt-2 tijorat-money-input" required maxlength="32" inputmode="numeric"
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <select name="region_id" class="input border w-full mt-2" required>
                            ...
                            @foreach ($regions as $region)
                                <option value="{{ $region->id }}" @selected(old('region_id') == $region->id)>{{ $region->oz }}</option>
                            @endforeach
                        </select>
                        @error('region_id')
                            <div class="text-theme-6 text-sm mt-1">{{ $message }}</div>
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="turi" value="{{ old('turi') }}" class="input w-full border mt-2" required maxlength="600">
                        @error('turi')
                            <div class="text-theme-6 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="yar_ish_urni" value="{{ old('yar_ish_urni') }}" class="input w-full border mt-2" required maxlength="600">
                        @error('yar_ish_urni')
                            <div class="text-theme-6 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="t_soha" value="{{ old('t_soha') }}" class="input w-full border mt-2" required maxlength="600">
                        @error('t_soha')
                            <div class="text-theme-6 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="q_soha" value="{{ old('q_soha') }}" class="input w-full border mt-2" required maxlength="600">
                        @error('q_soha')
                            <div class="text-theme-6 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-span-12">
                        ...
                        <textarea name="m_asosi" class="input w-full border mt-2" rows="3" required maxlength="600">{{ old('m_asosi') }}</textarea>
                        @error('m_asosi')
                            <div class="text-theme-6 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
