                    ...
                    <div style="display: flex;justify-content:center; border-bottom: 1px solid #e2e8f0; padding-bottom: 20px;">
                        <div style="text-align: center;display: flex;">
                            ...
                            @if ($tekshirivchilar->holati == 'Rad etildi')
                                ...
                                <form action="{{ route('asbobuskunaexpert.destroy', $tekshirivchilar->id) }}" method="POST"
                ...
                <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <form id="science-paper-create-form" method="POST" action="{{ route('asbobuskunaexpert.store') }}"
                        ...
                        <div class="grid grid-cols-12 gap-2">
                            ...
                            <div class="w-full col-span-6 ">
                                <label class="flex flex-col sm:flex-row"> <span
                                        class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span>Tashkilotning mas'ul rahbarining
                                    F.I.Sh</label>
