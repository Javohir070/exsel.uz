                    ...
                    <div class="overflow-x-auto"
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr class="bg-gray-200">
                                    <th class="border">Foydalanishga mas'ul tarkibiy bo‘linma (laboratoriya, kafedra,
                                        sho‘ba) nomi</th>
                                ...
                                <tr class="bg-gray-200">
                                    <th class="border">Laboratoriya uskunalari uchun zarur reagent va reaktivlar zaxirasi
                                    </th>
                                    <th class="border">Foydalanish uchun arizalarning ro‘yxatga olinishi va foydalanish
                                        jadvalining
                                        yuritilishi</th>
                                </tr>
                                <tr>
                                ...
                                <tr class="bg-gray-200">
                                    <th class="border">Ilmiy tadqiqot va oliy ta’lim muassasalari laboratoriyalarining
                                        qo‘shimcha
                                        asbob-uskunalarga ehtiyoji</th>
                                    <th class="border">Zarur sarflash materiallari va butlovchi qismlar bo‘yicha ehtiyoji
                                    </th>
                                </tr>
                                <tr>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="border border-b-2 ">
                                        {{ $quarter_1->lab_uskunalarini_mosligi ?? null }}</td>
                                </tr>
                                <tr class="bg-gray-200">
                                    ...
                                    <td class="border border-b-2 ">{{ $quarter_1->ilmiy_tadqiqot_ishilari ?? null }}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="border border-b-2 ">{{ $quarter_1->ilmiy_tadqiqot_hajmi ?? null }}
                                    </td>
                                </tr>
                                <tr class="bg-gray-200">
                                    ...
                                    <td class="border border-b-2 ">{{ $quarter_1->lab_zaxirasi ?? null }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="border border-b-2 ">{{ $quarter_1->foy_uchun_ariz ?? null }}</td>
                                </tr>
                                <tr class="bg-gray-200">
                                    ...
                                    <td class="border border-b-2 ">{{ $quarter_1->asbob_usk_ehtiyoji ?? null }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="border border-b-2 ">{{ $quarter_1->zarur_ehtiyoji ?? null }}</td>
                                </tr>
                                <tr class="bg-gray-200">
                                    ...
                                    <td class="border border-b-2 ">{{ $quarter_1->lab_ishga_yaroqliligi ?? null }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <table class="table">
                                        ...
                                        <div style="text-align: center;display: flex;">
                                            @role(['Ekspert'])
                                                @if ($tekshirivchilar->holati == 'yuborildi')
                                                    ...
                                                    <form action="{{ route('asbobuskunaexpert.update', $tekshirivchilar->id) }}"
                                            ...
                                            @role(['Ishchi guruh azosi'])
                                                @if ($tekshirivchilar->holati == 'Rad etildi')
                                                    ...
                                                    <form action="{{ route('asbobuskunaexpert.destroy', $tekshirivchilar->id) }}"
                                                        method="POST"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="border border-b-2 ">
                                                {{ $tekshirivchilar->lab_uskunalarini_mosligi ?? null }}</td>
                                        </tr>
                                        <tr class="bg-gray-200">
                                            <td class="border border-b-2 ">2.</td>
                                            <td class="border border-b-2 ">
                                            ...
                                            <td class="border border-b-2 ">
                                                {{ $tekshirivchilar->ilmiy_tadqiqot_ishilari ?? null }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border border-b-2 ">3.</td>
                                            <td class="border border-b-2 ">
                                            ...
                                            <td class="border border-b-2 ">
                                                {{ $tekshirivchilar->ilmiy_tadqiqot_hajmi ?? null }}</td>
                                        </tr>
                                        <tr class="bg-gray-200">
                                            <td class="border border-b-2 ">4.</td>
                                            <td class="border border-b-2 ">
                                                Laboratoriya uskunalari uchun zarur reagent va reaktivlar zaxirasining
                                                mavjudligi
                                            </td>
                                        ...
                                        <tr class="bg-gray-200">
                                            ...
                                            <td class="border border-b-2 ">{{ $tekshirivchilar->asbob_usk_ehtiyoji ?? null }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="border border-b-2 ">7.</td>
                                        ...
                                        <tr class="bg-gray-200">
                                            ...
                                            <td class="border border-b-2 ">
                                                {{ $tekshirivchilar->lab_ishga_yaroqliligi ?? null }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border border-b-2 ">9.</td>
                                            <td class="border border-b-2 ">Ekspert xulosasi
                                ...
                                <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2"
                                    ...
                                    <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                                        <form id="science-paper-create-form" method="POST"
                                            action="{{ route('asbobuskunaexpert.store') }}" class="validate-form"
                                            ...
                                            <div class="grid grid-cols-12 gap-2">
                                                ...
                                                <div class="w-full col-span-6">
                                                    <label class="flex flex-col sm:flex-row"> <span
                                                            class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Laboratoriya
                                                        uskunalarini
                                                        o'rnatilgan ilmiy bo'linma faoliyatiga mosligi
                                                    </label>
                                                    <select name="lab_uskunalarini_mosligi" class="input border w-full mt-2"
                                                        required="">
                                                ...
                                                <div class="w-full col-span-6">
                                                    <label class="flex flex-col sm:flex-row"> <span
                                                            class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Bajarilavotgan
                                                        ilmiy-tadqiqot
                                                        ishlari uchun zarurligi
                                                    </label>
                                                    <select name="ilmiy_tadqiqot_ishilari" class="input border w-full mt-2"
                                                        required="">
                                                ...
                                                <div class="w-full col-span-6">
                                                    ...
                                                    <select name="ilmiy_tadqiqot_hajmi" class="input border w-full mt-2"
                                                        required="">
                                                ...
                                                <div class="w-full col-span-6">
                                                    <label class="flex flex-col sm:flex-row"> <span
                                                            class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Foydalanish
                                                        uchun
                                                        arizalarning
                                                        ro'yxatga olinishi va foydalanish jadvalining yuritilishi
                                                        holatiga baho berish
                                                    </label>
                                                    <select name="foy_uchun_ariz" class="input border w-full mt-2"
                                                        required="">
                                                ...
                                                <div class="w-full col-span-6">
                                                    ...
                                                    <select name="asbob_usk_ehtiyoji" class="input border w-full mt-2"
                                                        required="">
                                                ...
                                                <div class="w-full col-span-6">
                                                    <label class="flex flex-col sm:flex-row"> <span
                                                            class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Zarur sarflash
                                                        materiallari
                                                        va
                                                        butlovchi qismlar bo'yicha ehtiyojar mavjudligi
                                                    </label>
                                                    <select name="zarur_ehtiyoji" class="input border w-full mt-2"
                                                        required="">
                                                ...
                                                <div class="w-full col-span-6">
                                                    ...
                                                    <select name="lab_ishga_yaroqliligi" class="input border w-full mt-2"
                                                        required="">
