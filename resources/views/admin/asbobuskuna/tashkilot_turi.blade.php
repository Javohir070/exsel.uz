                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="color:#1881D3; font-weight: 400;">
                                                    <a href="{{ route('search_asbobuskunalar', ['id' => $regions->id, 'type'=>'otm']) }}">OTM</a>     
                                                    </td>
                                            ...
                                            <tr>
                                                <td style="color:#1881D3; font-weight: 400;">
                                                    <a href="{{ route('search_asbobuskunalar', ['id' => $regions->id,'type'=>'itm']) }}"> Ilmiy tashkilotlar</a>    
                                                </td>
                                                <td style="text-align: center;">
                                            ...
                                            <tr>
                                                <td style="color:#1881D3; font-weight: 400;">
                                                    <a href="{{ route('search_asbobuskunalar', ['id' => $regions->id, 'type'=>'boshqa']) }}">Boshqa tashkilotlar</a>    
                                                </td>
                                                <td style="text-align: center;">
