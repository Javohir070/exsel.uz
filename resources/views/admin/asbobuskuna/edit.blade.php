...
@section('content')
    ...
    <div class="intro-y col-span-6 flex flex-wrap sm:flex-no-wrap items-center mt-2 monitoring-form">
            ...
            <form id="science-paper-create-form" method="POST" action="{{ route("asbobuskuna.update", $asbobuskuna->id) }}"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="number" name="soni" value="{{ old('soni', $asbobuskuna->soni) }}" min="0" step="1"
