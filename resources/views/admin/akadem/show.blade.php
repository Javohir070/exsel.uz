        ...
        <div class="intro-y box px-4 mt-5">
            <div class="nav-tabs flex flex-col sm:flex-row justify-center lg:justify-start">
                ...
                <a data-toggle="tab" data-target="#add-hersh" href="javascript:;"
                    ...
                    Akademik harakatchanlik ma’lumoti
                </a>
        ...
        <div class="overflow-x-auto" style="background-color: white;margin-top:30px;border-radius:8px;padding:30px 20px;">
            <div class="tab-content mt-1">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr class="bg-gray-200">
                                        ...
                                        <td class="border border-b-2 ">Gʻolib yosh olim faoliyat yuritayotgan tashkilotlarning
                                            ilm-fan
                                        ...
                                        <td class="border border-b-2 ">
                                            {{ $quarter_2->kalendar_reja_monitoring == 'bajarilgan' ? 'Bajarilgan' : ($quarter_2->kalendar_reja_monitoring == 'bajarilmagan' ? 'Bajarilmagan' : 'Loyiha davom etmoqda') }}
                                            <br> <b>Izoh:</b> {{ $quarter_2->kalendar_reja_monitoring_izox }}
                                        </td>
                                    </tr>

                                    <tr>
                                        <td class="border border-b-2 ">2</td>
                                        <td class="border border-b-2 ">Loyiha bajarilishi yakunlanganidan soʻng qabul qiluvchi
                                            tashkilot
                                            va gʻolib yosh olim oʻrtasida loyihani amalga oshirish xarajatlari koʻrsatilgan
                                            holda
                                            bajarilgan ishlar boʻyicha dalolatnoma tuzilganligi </td>
                                        <td class="border border-b-2 ">
                                            {{ $quarter_2->dalolatnoma_tuzilgan == 'bajarilgan' ? 'Bajarilgan' : ($quarter_2->dalolatnoma_tuzilgan == 'bajarilmagan' ? 'Bajarilmagan' : 'Loyiha davom etmoqda') }}
                                            <br> <b>Izoh:</b> {{ $quarter_2->dalolatnoma_tuzilgan_izox }}
                                        </td>
                                    </tr>

                                    <tr class="bg-gray-200">
                                        <td class="border border-b-2 ">3</td>
                                        <td class="border border-b-2 ">“Akademik harakatchanlik” dasturi doirasida olib borilgan
                                            loyiha
                                            natijalari hisoboti faoliyat yuritayotgan muassasa rahbari tomonidan tasdiqlangan
                                            holda
                                            ilmiy, ilmiy-texnik kengashda muhokama qilingani
                                        </td>
                                        <td class="border border-b-2 ">
                                            {{ $quarter_2->hisobot_muhokama_qilingan == 'bajarilgan' ? 'Bajarilgan' : ($quarter_2->hisobot_muhokama_qilingan == 'bajarilmagan' ? 'Bajarilmagan' : 'Loyiha davom etmoqda') }}
                                            <br> <b>Izoh:</b> {{ $quarter_2->hisobot_muhokama_qilingan_izox }}
                                        </td>
                                    </tr>

                                    <tr>
                                        <td class="border border-b-2 ">4</td>
                                        <td class="border border-b-2 ">Gʻolib yosh olim yigʻilish bayonnoma koʻchirmasi,
                                            ajratilgan
                                            mablagʻlarning sarflanganligi boʻyicha hisobotni Agentlikka taqdim etganligi </td>
                                        <td class="border border-b-2 ">
                                            {{ $quarter_2->hisobot_agentlikka_taqdim == 'bajarilgan' ? 'Bajarilgan' : ($quarter_2->hisobot_agentlikka_taqdim == 'bajarilmagan' ? 'Bajarilmagan' : 'Loyiha davom etmoqda') }}
                                            <br> <b>Izoh:</b> {{ $quarter_2->hisobot_agentlikka_taqdim_izox }}
                                        </td>
                                    </tr>
                ...
                <div class="tab-content__pane" id="add-expert">
                    @role(['Ekspert', 'akadem boyicha masul', 'Ishchi guruh azosi', 'Rahbar', 'super-admin'])
                                    ...
                                    <div class="grid grid-cols-12 gap-2">
                                        ...
                                        <div class="field-group w-full col-span-6">
                                            <label class="flex flex-col sm:flex-row"> <span
                                                    class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Gʻolib yosh olim
                                                faoliyat
                                            ...
                                            <textarea name="kalendar_reja_monitoring_izox" id=""
                                                class="input w-full border mt-2" placeholder="Izoh" cols="2" rows="2"
                                                required></textarea>
                                        ...
                                        <div class="field-group w-full col-span-6">
                                            <label class="flex flex-col sm:flex-row"> <span
                                                ...
                                                yakunlanganidan soʻng qabul qiluvchi tashkilot va gʻolib yosh olim oʻrtasida
                                                loyihani
                                                amalga oshirish xarajatlari koʻrsatilgan holda bajarilgan ishlar boʻyicha
                                                dalolatnoma
                                                tuzilganligi
                                            </label>
                                            <select name="dalolatnoma_tuzilgan"
                                                class="input border w-full mt-2 show-comment-select" required="">
                                            ...
                                            <textarea name="dalolatnoma_tuzilgan_izox" id="" class="input w-full border mt-2"
                                                placeholder="Izoh" cols="2" rows="2" required></textarea>
                                        ...
                                        <div class="field-group w-full col-span-6">
                                            <label class="flex flex-col sm:flex-row"> <span
                                                    class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> “Akademik
                                                harakatchanlik”
                                                dasturi doirasida olib borilgan loyiha natijalari hisoboti faoliyat yuritayotgan
                                                muassasa
                                                rahbari tomonidan tasdiqlangan holda ilmiy, ilmiy-texnik kengashda muhokama
                                                qilingani
                                            </label>
                                            ...
                                            <textarea name="hisobot_muhokama_qilingan_izox" id=""
                                                class="input w-full border mt-2" placeholder="Izoh" cols="2" rows="2"
                                                required></textarea>
                                        ...
                                        <div class="field-group w-full col-span-6">
                                            <label class="flex flex-col sm:flex-row"> <span
                                                    class="mt-1 mr-1 sm:mt-0 text-xs text-red-600">*</span> Gʻolib yosh olim
                                                yigʻilish
                                                bayonnoma koʻchirmasi, ajratilgan mablagʻlarning sarflanganligi boʻyicha
                                                hisobotni
                                            ...
                                            <textarea name="hisobot_agentlikka_taqdim_izox" id=""
                                                class="input w-full border mt-2" placeholder="Izoh" cols="2" rows="2"
                                                required></textarea>
                                        ...
                                        <div class="w-full col-span-6 ">
                                            ...
                                            <textarea name="comment" id="" class="input w-full border mt-2" placeholder="Xulosa"
