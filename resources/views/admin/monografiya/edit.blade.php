...
@section('content')
    ...
    <div class="flex justify-between align-center mt-6 mb-6">
        ...
        <h2 class="intro-y text-lg font-medium">Monografiya ma'lumotni tahrirlash</h2>

        <div>
            <a href="{{ route("monografiyalar.index") }}" class="button w-24 ml-3 bg-theme-1 text-white">
                Orqaga
            </a>
        </div>
    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2"
        ...
        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <form id="science-paper-edit-form" method="POST"
                action="{{ route("monografiyalar.update", $monografiyalar->id) }}" class="validate-form"
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="name" value="{{ old('name', $monografiyalar->name) }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="chop_etil_nashriyot"
                            value="{{ old('chop_etil_nashriyot', $monografiyalar->chop_etil_nashriyot) }}"
                            class="input w-full border mt-2" required>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        {{-- <input type="text" name="til" value="{{ old('til', $monografiyalar->til) }}"
                            class="input w-full border mt-2" required> --}}
                        <select name="til" id="science-sub-category" class="input border w-full mt-2" required="">

                            <option value=""></option>

                            <option value="uzb" {{ $monografiyalar->til == "uzb" ? "selected" : ""}}>uzb</option>

                            <option value="rus" {{ $monografiyalar->til == "rus" ? "selected" : ""}}>rus</option>

                            <option value="eng" {{ $monografiyalar->til == "eng" ? "selected" : ""}}>eng</option>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="kbk" value="{{ old('kbk', $monografiyalar->kbk) }}"
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="isbn" value="{{ old('isbn', $monografiyalar->isbn) }}"
                            class="input w-full border mt-2">
                        @error('isbn')
                            <div class="error">{{ $message }}</div>
                        @enderror
                            ...
                            @foreach(json_decode($monografiyalar->mualliflar_json) as $muallif)
                                <div class="muallif-input">
                                    <input type="text" name="mualliflar_json[]" class="input w-full border mt-2"
                                        value="{{ old('mualliflar_json[]', $muallif) }}" placeholder="Muallifning F.I.Sh"
                                        required>
                                </div>
                            @endforeach
                        </div>
