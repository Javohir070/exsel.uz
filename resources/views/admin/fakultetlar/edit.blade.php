...
<div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2" style="background: white;
    ...
    <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
        <form id="science-paper-create-form" method="POST" action="{{ route("fakultetlar.update",['fakultetlar'=>$fakultetlar->id]) }}"
            ...
            <div class="grid grid-cols-12 gap-2">
                    <div class="w-full col-span-6">
                        ...
                        <input type="text" name="name" value="{{ $fakultetlar->name }}" class="input w-full border mt-2" required="">
                        @error('name')
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <input type="number" name="tash_yil" value="{{ $fakultetlar->tash_yil }}" class="input w-full border mt-2" required="">
                        @error('tash_yil')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
