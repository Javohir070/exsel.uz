                        ...
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">
                                    {{ $tashkiot_haqida->tash_xodimlar ?? 0 }}/{{ $xodimlar}}</div>
        ...
        <table class="table">
            <tbody>
                ...
                @forelse ($iqtisodiy_moliyaviy as $iqtisodiy)
                    <tr>
                        <th class="border" style="text-align: center;font-size:20px;color: #1C3FAA;" colspan="3">
                            Iqtisodiy-moliyaviy faoliyat </th>
                    </tr>
                    <tr class="bg-gray-200">
