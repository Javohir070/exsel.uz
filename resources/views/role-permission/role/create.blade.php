...
@section("content")
    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2 monitoring-form">
        <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <form id="science-paper-create-form" method="POST" action="{{ url('roles') }}" class="validate-form"
                ...
                <div class="grid grid-cols-12 gap-2">
                    <div class="w-full col-span-12">
                        ...
                        <input type="text" name="name" class="input w-full border mt-2" required="" value="{{ old('name') }}">
                        @error('name')
