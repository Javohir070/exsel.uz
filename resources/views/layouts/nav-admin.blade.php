    ...
    <ul>
        ...
        <li>
            <a href="{{ route('tijorat.index') }}"
                ...
                <div class="side-menu__icon"> <i data-feather="inbox"></i> </div>
                <div class="side-menu__title"> Tijoratlashtirish</div>
            </a>
        </li>
        ...
        <li>
            ...
            <ul
                ...
                <li>
                    <a href="{{ route('tashkilot.users.index') }}"
                        class="side-menu side-menu{{ request()->is('tashkilot/users*') ? '--active' : '' }}">
                        <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="side-menu__title"> Tashkilot foydalanuvchilar </div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        {{-- <li>
            <a href="" class="side-menu side-menu{{ request()->is('izlanuvchilar*') ? '--active' : '' }}">
                <div class="side-menu__icon"> <i data-feather="file-text"></i> </div>
                <div class="side-menu__title">Ilmiy izlanuvchilar </div>
            </a>
        </li> --}}
