...
class StoreStajirovkaRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'ilmiy_hisobot_2' => 'required|file|mimes:zip,rar|max:10480',
            'egallangan_bilim_2' => 'required|file|mimes:zip,rar|max:10480',
            'ishlar_natijalari_2' => 'required|file|mimes:zip,rar|max:10480',
            'xalqarotan_jur_nashr_2' => 'required|file|mimes:zip,rar|max:10480',
