...
class DalolatnomaController extends Controller
{
    ...
    public function store(StoreDalolatnomaRequest $request)
    {
        $request->validate([
            ...
            'joyiye_obyekti' => 'required|string|max:255',
            'joyiye_maqsadi' => 'required|string|max:255',
            'joyiye_asos' => 'required|string|max:255',
            'joyiye_tashkilot' => 'required|string|max:255',
            'joyiye_tarmoq' => 'required|string|max:255',
