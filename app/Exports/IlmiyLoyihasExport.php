    ...
    public function collection()
    {
        return IlmiyLoyiha::with('tashkilot')->get()->map(function ($ilmiyloyhalar){
            return [
                ...
                '2017 yil' => $ilmiyloyhalar->umumiyyil_id->y2017,
                '2018 yil' => $ilmiyloyhalar->umumiyyil_id->y2018,
                '2019 yil' => $ilmiyloyhalar->umumiyyil_id->y2019,
                '2020 yil' => $ilmiyloyhalar->umumiyyil_id->y2020,
                '2021 yil' => $ilmiyloyhalar->umumiyyil_id->y2021,
                '2022 yil' => $ilmiyloyhalar->umumiyyil_id->y2022,
                '2023 yil' => $ilmiyloyhalar->umumiyyil_id->y2023,
                '2024 yil' => $ilmiyloyhalar->umumiyyil_id->y2024,
